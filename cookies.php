...
<html lang="en" dir="ltr">
  ...
  <body id="main">
    ...
    <h1>Cookies on our site</h1>

    <p>We use cookies and similar tools on our website at https://www.papier.com/ (“Website”) to improve its performance and enhance your user experience. This policy explains how we do that.</p>
    ...
    <p>Certain cookies contain personal information – for example, if you click to “remember me” when logging in, a cookie will store your username. Most cookies will not collect information that identifies you, but will instead collect more general information such as how users arrive at and use the Website.</p>
    ...
    <h6>DOES ANYONE ELSE USE COOKIES ON THE WEBSITE?</h6>
  ...
  <tr>
    <td>Ometria</td>
    <td>Allows us to subscribe people to our newsletter, to provide you with information about products you may be interested in	</td>
    <td>Analytics, research & performance</td>
  </tr>
  <tr>
    <td>Crazy Egg	</td>
    <td>Allows us to see in greater detail how people are using the website, to help improve the experience	</td>
    <td>Analytics, research & performance</td>
  </tr>
  <tr>
    <td>Google Adwords</td>
    <td>Allows us to deliver ads that are relevant to you. They also limit the number of times that you see an ad and help us measure the effectiveness of our advertising campaigns	</td>
    <td>Analytics, research & performance</td>
  </tr>
</table>
